...
paths = ['/media/sf_ece535SLAM/config/mhealth/split_ae/acce_gyro/A0_B0_AB30_label_A_test_B', # UmFL
         ...
         '/media/sf_ece535SLAM/config/mhealth/ablation/acce_gyro/A30_B30_AB0_label_A_test_B', # Baseline
         ...
         '/media/sf_ece535SLAM/config/opp/ablation/A30_B30_AB0_label_A_test_B', # Baseline
         ...
         '/media/sf_ece535SLAM/config/ur_fall/ablation/rgb_depth/A30_B30_AB0_label_A_test_B'] # # Baseline
